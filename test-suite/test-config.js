...
module.exports = {
    ...
    // 测试数据路径
    testData: {
        inputFolder: path.join(__dirname, '..', 'test-data', 'input'),
        outputFolder: path.join(__dirname, '..', 'test-data', 'output'),
        legilRefFolder: path.join(__dirname, '..', 'test-data', 'legil-ref')
    },
